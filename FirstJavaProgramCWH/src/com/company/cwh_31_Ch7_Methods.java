...
public class cwh_31_Ch7_Methods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The result of variable 'a and b' acc. to logic will be " + c);
        ...
        System.out.println("The result of variable 'a1 and a2' acc. to logic will be " + c1 + "\n");
        ...
        // Method-1: Directly call static method using logic
        c = logic(a, b);
        c1 = logic(a1, b1);
